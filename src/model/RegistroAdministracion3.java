...
public class RegistroAdministracion3 extends JFrame implements ActionListener {
	...
	public RegistroAdministracion3() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		
		setTitle("GESTOR ENVÍO");
		setResizable(false);
	...
	public void actionPerformed(ActionEvent e) {
			if(btnRegistrar==e.getSource()) {
				...
				boolean registro = Administrador.registrarPersona(nombre, id,apellido,telefono,"gestorEnvio");
				Administrador.crearCarpeta("gestorEnvio",nombreCompleto,registro);
