...
public class RegistroAdministracion2 extends JFrame implements ActionListener {
		...
		public RegistroAdministracion2() {
		...
		public void actionPerformed(ActionEvent e) {
				if(btnRegistrar==e.getSource()) {
					...
					boolean registro = Administrador.registrarPersona(nombre, id,apellido,telefono, "cliente");
					Administrador.crearCarpeta("clientes",nombreCompleto,registro);
